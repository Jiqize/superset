...
import { AAActiveTasksProjectShell } from "renderer/routes/_authenticated/_dashboard/components/AAOffice/AAActiveTasks";
	...
	return (
		<AnimatePresence initial={false}>
			{!isCollapsed && (
				...
				>
					<div className="pb-1">
						<AAActiveTasksProjectShell
							enabled={aaOffice}
							projectId={projectId}
							workFolderCount={workspacesById.size}
						>
